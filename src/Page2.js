  ...
  useEffect(() => {
    const map = async () => {
      ...
      const radiusScale = d3.scaleSqrt()
        .domain([0, d3.max(usData, (d) => d.casualities)])
      ...
      svg.selectAll('circle')
        ...
        .attr('r', (d) => radiusScale(d.casualities)) // Set the radius based on casualties
        .style('fill', (d) => (d.Year === selectedYear ? 'yellow' : 'red')) // Change fill color dynamically
        ...
        .on('mouseover', function (event, d) {
          ...
          tooltip.html(`
            ...
            <strong>Casualties:</strong> ${d.casualities}<br/>
        ...
        .on('mouseout', function () {
          ...
          d3.select(this)
            .style('fill', (d) => (d.Year === selectedYear ? 'yellow' : 'red'))
            .style('fill-opacity', 0.5);
